...
r = requests.post("http://pavliati.pythonanywhere.com/robots/calculate/balance/", json={'robot': 'ALL', 'start_date': str(date.today()), 'end_date': str(date.today())})
...
# r = requests.post("http://127.0.0.1:8000/robots/robots/calculate/balance/", json={'robot': 'ALL', 'start_date': str(date.today()), 'end_date': str(date.today())})
